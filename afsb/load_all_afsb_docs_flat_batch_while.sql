...
AS
    v_offset          NUMBER := 10000;
    v_total_count     NUMBER;
BEGIN
    SELECT COUNT(*)
      INTO v_total_count
      FROM dm_dct_data_ds_elem;
    ...
    WHILE v_offset < v_total_count LOOP
        ...
        SELECT
            ...
            b.load_username AS loadUserName,
            b.edit_username AS editUserName,
            b.document_status AS documentStatus,
            b.is_visible AS isVisible,
            b.is_exported AS isExported,
            b.is_bg_member AS isBGMember,
            b.file_name AS fileName,
            b.document_name AS documentName,
            b.document_type AS documentType,
            b.document_number AS documentNumber,
            b.document_date AS documentDate,
            b.ko_section AS koSection,
            b.ko_sections AS koSections,
            ko.section_text AS koSectionText,
            b.bg_section AS bgSection,
            b.bg_sections AS bgSections,
            bg.section_text AS bgSectionText,
            b.document_note AS documentNote,
            b.pm_address AS pmAdress,
            b.bg AS bg
        FROM base_docs b
...
BEGIN
    load_all_afsb_docs_flat_batch(10000);
END;
/
