...
/**
 * Стратегия для панели миграции разрешений
 */
public class PermissionMigrationPanelStrategy implements SaveablePanelStrategy {
    
    private static final Logger logger = LogManager.getLogger(PermissionMigrationPanelStrategy.class);
    ...
    public PanelType getPanelType() {
        return PanelType.PERMISSION_MIGRATION;
    }
